...
{
    TRACE("Entering CSpaceshipFactroy::XClassFactory::QueryInterface--nIid=%d\n", nIid);
...
{
    TRACE("Entering CSpaceshipFatory::XClassFactory::CreateInstance\n");
    METHOD_PROLOGUE(CSpaceshipFactory, ClassFactory) // makes pThis
...
// In real COM, this would be DllGetClassObject, which would be called whenever a client called CoGetClassObject
