...
#ifndef __PROGBARPEEKMSG_H__
#define __PROGBARPEEKMSG_H__
...
class CProgBarPeekMsgApp : public CWinApp {
public:
    CProgBarPeekMsgApp() {}
...
#undef MODULE_NAME
#define MODULE_NAME     "ProgBarPeekMsg"   // 程序模块名
...
extern CProgBarPeekMsgApp      g_ProgBarPeekMsgApp;   // 应用程序实例
