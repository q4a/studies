...
namespace L09Reflection
{
    ...
    public class Skybox
    {
        ...
        /// you may need to change the size of your skybox to prevent it from being beyond the far clipping plane and being cut out,
        /// but still large enough that the rest of your scene doesn't run into it.
        /// </summary>
            ...
            foreach (EffectPass pass in skyBoxEffect.CurrentTechnique.Passes)
            {
                ...
                foreach (ModelMesh mesh in skyBox.Meshes)
                {
                    ...
                    foreach (ModelMeshPart part in mesh.MeshParts)
                    {
                        ...
                        // This is done so that the skybox is centered around the camera, so that as you move through your scene, the skybox stays still, relative to the viewer.
