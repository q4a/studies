...
// 应用程序实例
CProgBarWorkThreadApp g_ProgBarWorkThreadApp;

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CProgBarWorkThreadApp
////////////////////////////////////////////////////////////////////////////////

BOOL CProgBarWorkThreadApp::InitInstance()
{
...
int CProgBarWorkThreadApp::ExitInstance()
{
    // 恢复旧的工作目录
...
BOOL CProgBarWorkThreadApp::InitModulePath(DWORD size)
{
...
BOOL CProgBarWorkThreadApp::InitWorkDir(const _TCHAR* dir)
{
...
CString CProgBarWorkThreadApp::GetModuleDir() const
{
