...
#ifndef __PROGBAREVENT_H__
#define __PROGBAREVENT_H__
...
class CProgBarEventApp : public CWinApp {
public:
    CProgBarEventApp() {}
...
#undef MODULE_NAME
#define MODULE_NAME     "ProgBarEvent"   // 程序模块名
...
extern CProgBarEventApp      g_ProgBarEventApp;   // 应用程序实例
