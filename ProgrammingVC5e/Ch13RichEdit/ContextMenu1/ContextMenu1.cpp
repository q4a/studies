...
CContextMenu1App ContextMenu1App;   // 应用程序实例

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CContextMenu1App
////////////////////////////////////////////////////////////////////////////////

BOOL CContextMenu1App::InitInstance()
{
...
int CContextMenu1App::ExitInstance()
{
    // 恢复旧的工作目录
...
BOOL CContextMenu1App::InitModulePath(DWORD size)
{
...
BOOL CContextMenu1App::InitWorkDir(const _TCHAR* dir)
{
...
CString CContextMenu1App::GetModuleDir() const
{
