// MyPaint.cpp : Defines the class behaviors for the application.
//
...
// The one and only CMyPaintApp object

CMyPaintApp theApp;


// CMyPaintApp initialization
