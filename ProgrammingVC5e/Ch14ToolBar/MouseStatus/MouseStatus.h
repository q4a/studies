// MouseStatus.h : main header file for the MouseStatus application
//
#pragma once
...
#undef MODULE_NAME
#define MODULE_NAME     "MouseStatus"   // 程序模块名
...
// CMouseStatusApp:
// See MouseStatus.cpp for the implementation of this class
//

class CMouseStatusApp : public CWinApp {
public:
    CMouseStatusApp();
